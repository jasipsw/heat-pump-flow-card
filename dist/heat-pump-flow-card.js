          ...
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="g2-valve" transform="translate(240, 200)">
              ...
              <circle cx="0" cy="0" r="18"
                      fill="${s.isActive?this.config.heat_pump_visual?.dhw_color:this.config.heat_pump_visual?.heating_color}"
                      stroke="#2c3e50"
                      stroke-width="3"
                      opacity="0.9"/>
              ...
              <text x="0" y="-16" text-anchor="middle" fill="${s.isActive?this.config.heat_pump_visual?.dhw_color:this.config.heat_pump_visual?.heating_color}" font-size="10" font-weight="bold">
                ${s.isActive?"DHW":"HEAT"}
              </text>
            </g>
