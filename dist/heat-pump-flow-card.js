        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="aux-heater"
              ...
              <rect x="${$}" y="${x}" width="${60}" height="${16}" rx="2" ry="2"
                    class="${G}"
                    fill="${w}"
                    stroke="#2d3748"
                    stroke-width="1.5"/>
