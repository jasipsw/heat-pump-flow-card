        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)" filter="url(#entity-shadow)">
              ...
              <text x="8" y="${L}" fill="${P}" font-size="10" font-weight="bold">IN</text>
              <text x="8" y="${L+14}" fill="${P}" font-size="10">${this.formatValue(t.power/1e3,1)} kW</text>

              <!-- Right column: OUTPUT parameters -->
              <text x="62" y="${L}" fill="${P}" font-size="10" font-weight="bold">OUT</text>
              <text x="62" y="${L+14}" fill="${P}" font-size="10">${this.formatValue(t.thermal/1e3,1)} kW</text>
              <text x="62" y="${L+28}" fill="${P}" font-size="9">COP ${this.formatValue(t.cop,2)}</text>

              <!-- Flow rate display at bottom -->
              <text x="60" y="${L+42}" text-anchor="middle" fill="${P}" font-size="9">
