        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="aux-heater"
              ...
              ${Q`<rect x="${H}" y="${E}" width="${L}" height="${16}" rx="2" ry="2"
                    class="${at}"
                    fill="${C}"
                    stroke="#7f8c8d"
