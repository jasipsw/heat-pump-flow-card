        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="buffer-tank" transform="translate(390, 100)" filter="url(#entity-shadow)">
              ...
              <rect x="10" y="20" width="70" height="140" fill="${y.length>0?"none":"#34495e"}" stroke="#2c3e50" stroke-width="3"/>
              ...
              ${y.length>0?W`
                ...
                ${y.map(t=>W`
                  <rect x="15" y="${t.y.toString()}" width="60" height="${t.height.toString()}"
                        fill="${t.color}" opacity="${t.opacity.toString()}"></rect>
                `)}
              `:W`
            ...
            <g id="dhw-tank" transform="translate(390, 330)" filter="url(#entity-shadow)">
              <!-- Tank cylinder body - reduced from 160 to 140 height -->
              <rect x="10" y="20" width="70" height="140" fill="${_.length>0?"none":"#34495e"}" stroke="#2c3e50" stroke-width="3"/>
