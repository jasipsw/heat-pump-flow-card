          ...
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)">
              ...
              ${this.config.heat_pump?.display_name?I`
                <text x="60" y="12" text-anchor="middle" fill="${this.getHeatPumpColor(t)}" font-size="9" font-weight="bold">
              ...
              ${(()=>{const e=this.getHeatPumpColor(t),o=this.getContrastTextColor(e),i=t.error?115:100;return I`
                  <!-- Left column: INPUT parameters -->
                  <text x="8" y="${i}" fill="${o}" font-size="10" font-weight="bold">IN</text>
                  <text x="8" y="${i+14}" fill="${o}" font-size="10">${this.formatValue(t.power/1e3,1)} kW</text>
                  <text x="8" y="${i+28}" fill="${o}" font-size="9">${this.formatValue(t.flowRate,1)} L/m</text>

                  <!-- Right column: OUTPUT parameters -->
                  <text x="62" y="${i}" fill="${o}" font-size="10" font-weight="bold">OUT</text>
                  <text x="62" y="${i+14}" fill="${o}" font-size="10">${this.formatValue(t.thermal/1e3,1)} kW</text>
                  <text x="62" y="${i+28}" fill="${o}" font-size="9">COP ${this.formatValue(t.cop,2)}</text>
                `})()}
            </g>
