      ...
      <ha-card>
        ...
        <div class="card-content">
          <svg viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
            ...
            <text x="260" y="170" text-anchor="middle" fill="${o}" font-size="11" font-weight="bold">
              Out: ${this.formatValue(t.outletTemp,1)}°
            </text>

            <!-- Buffer to HP (cold inlet) - below pipe -->
            <text x="260" y="240" text-anchor="middle" fill="${s}" font-size="11" font-weight="bold">
              In: ${this.formatValue(t.inletTemp,1)}°
            </text>

            <!-- Buffer to HVAC (hot supply) - above pipe -->
            <text x="540" y="170" text-anchor="middle" fill="${r}" font-size="11" font-weight="bold">
              Supply: ${this.formatValue(e.supplyTemp,1)}°
            </text>

            <!-- HVAC to Buffer (cold return) - below pipe -->
            <text x="540" y="240" text-anchor="middle" fill="${n}" font-size="11" font-weight="bold">
              Return: ${this.formatValue(i.returnTemp,1)}°
            </text>
