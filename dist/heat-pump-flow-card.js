        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <path id="buffer-to-hp-path"
                  ...
                  fill="none"
                  stroke-linecap="butt"
                  opacity="${a.isActive?"0.3":t.flowRate>this.config.animation.idle_threshold?"0":"1"}"/>
            ...
            <g id="buffer-tank" transform="translate(390, 100)" filter="url(#entity-shadow)">
              ...
              ${y.length>0?this.renderGradientRects(y):U`
            ...
            <g id="dhw-tank" transform="translate(390, 330)" filter="url(#entity-shadow)">
              ...
              ${x.length>0?this.renderGradientRects(x):U`
            ...
            <g id="aux-heater"
              ...
              ${Q`<rect x="${P}" y="${E}" width="${T}" height="${16}" rx="2" ry="2"
                    class="${at}"
                    fill="${C}"
                    stroke="#7f8c8d"
