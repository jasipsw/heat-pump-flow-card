          ...
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            ${!1!==this.config.animation?.enabled?W`
              ...
              <path class="flow-gradient"
                    ...
                    style="--flow-duration: ${this.getAnimationDuration(t.flowRate)}s; --flow-dash-length: 100;"/>
              ...
              <path class="flow-gradient"
                    ...
                    stroke-linecap="round"
                    stroke-dasharray="30 70"
                    style="--flow-duration: ${this.getAnimationDuration(i.flowRate)}s; --flow-dash-length: 100;"/>
              ...
              <path class="flow-gradient"
                    ...
                    style="--flow-duration: ${1.5*this.getAnimationDuration(t.flowRate)}s; --flow-dash-length: 100;"
            ...
            <g id="aux-heater"
               ...
               style="--aux-anim-speed: ${U}s; --aux-shadow-blur: ${N};">
