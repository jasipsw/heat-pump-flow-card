        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)">
              ...
              <circle cx="60" cy="48" r="30" fill="#34495e" stroke="${this.getHeatPumpColor(t)}" stroke-width="2"/>
              ...
              <!-- Heat pump label -->
              <text x="60" y="93" text-anchor="middle" fill="${this.getHeatPumpColor(t)}" font-size="10" font-weight="bold">
