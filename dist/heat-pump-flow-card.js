      ...
      <ha-card>
        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            ${t.flowRate>this.config.animation.idle_threshold?G`
              <defs>
            ...
            ${!r.isActive&&t.flowRate>this.config.animation.idle_threshold?G`
              <defs>
            ...
            ${o.flowRate>this.config.animation.idle_threshold?G`
              <defs>
            ...
            <g id="dhw-tank" transform="translate(390, 330)" filter="url(#entity-shadow)">
              ...
              ${x.length>0?this.renderGradientRects(x):G`
