          ...
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
              ...
              <filter id="aux-heater-glow" x="-100%" y="-100%" width="300%" height="300%">
                ...
                <feFlood flood-color="#ff4422" flood-opacity="${$}" result="glow-color"/>
            ...
            <g id="dhw-tank" transform="translate(390, 330)">
              ...
              <circle cx="28" cy="85" r="3" fill="${s.isActive?f:this.config.temperature?.neutral_color||"#95a5a6"}"/>
