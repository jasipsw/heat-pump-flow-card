        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="aux-heater"
              ...
              ${G`<rect x="${D}" y="${R}" width="${O}" height="${16}" rx="2" ry="2"
                    class="${dt}"
                    fill="${L}"
                    stroke="#7f8c8d"
