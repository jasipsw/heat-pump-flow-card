        ...
        <div class="card-content">
          <svg viewBox="0 0 800 650" xmlns="http://www.w3.org/2000/svg">
            ...
            ${s.isActive?B`
              ...
              <text x="195" y="170" text-anchor="middle" fill="${p}" font-size="11" font-weight="bold">
                Supply: ${this.formatValue(t.outletTemp,1)}°
              </text>
              <text x="195" y="260" text-anchor="middle" fill="${u}" font-size="11" font-weight="bold">
                Return: ${this.formatValue(t.inletTemp,1)}°
              </text>
            ...
            `:B`
              ...
              <text x="280" y="170" text-anchor="middle" fill="${l}" font-size="11" font-weight="bold">
                HP Supply: ${this.formatValue(t.outletTemp,1)}°
              </text>

              <!-- Heat Pump Return (cold) - below pipe -->
              <text x="280" y="260" text-anchor="middle" fill="${h}" font-size="11" font-weight="bold">
                HP Return: ${this.formatValue(t.inletTemp,1)}°
              </text>

              <!-- HVAC Supply (hot from buffer) - above pipe -->
              <text x="540" y="170" text-anchor="middle" fill="${c}" font-size="11" font-weight="bold">
                HVAC Supply: ${this.formatValue(e.supplyTemp,1)}°
              </text>

              <!-- HVAC Return (cold to buffer) - below pipe -->
              <text x="540" y="240" text-anchor="middle" fill="${d}" font-size="11" font-weight="bold">
                HVAC Return: ${this.formatValue(i.returnTemp,1)}°
              </text>
            `}
            ...
            <g id="g2-valve" transform="translate(220, 180)">
              <!-- Valve body -->
              <circle cx="0" cy="0" r="15" fill="${s.isActive?this.config.heat_pump_visual?.dhw_color:this.config.heat_pump_visual?.heating_color}" stroke="#2c3e50" stroke-width="2"/>
            ...
            <g id="buffer-tank" transform="translate(350, 80)">
              ...
              <rect x="15" y="80" width="70" height="55" fill="${c}" opacity="0.8"/>
              <!-- Structural bands -->
            ...
            <g id="dhw-tank" transform="translate(350, 330)">
              ...
              <circle cx="30" cy="40" r="3" fill="${p}"/>
              <circle cx="70" cy="115" r="3" fill="${u}"/>
              <!-- Structural bands -->
              <line x1="10" y1="50" x2="90" y2="50" stroke="#2c3e50" stroke-width="2"/>
              <line x1="10" y1="80" x2="90" y2="80" stroke="#2c3e50" stroke-width="2"/>
              <line x1="10" y1="110" x2="90" y2="110" stroke="#2c3e50" stroke-width="2"/>
              ...
              ${o.tankTemp?B`
                <text x="50" y="170" text-anchor="middle" fill="#3498db" font-size="11" font-weight="bold">
                  Tank: ${this.formatValue(o.tankTemp,1)}°
                </text>
              `:""}
            </g>
