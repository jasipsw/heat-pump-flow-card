        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)">
              ...
              <text x="8" y="${m}" fill="${u}" font-size="10" font-weight="bold">IN</text>
              <text x="8" y="${m+14}" fill="${u}" font-size="10">${this.formatValue(t.power/1e3,1)} kW</text>
              <text x="8" y="${m+28}" fill="${u}" font-size="9">${this.formatValue(t.flowRate,1)} L/m</text>

              <!-- Right column: OUTPUT parameters -->
              <text x="62" y="${m}" fill="${u}" font-size="10" font-weight="bold">OUT</text>
              <text x="62" y="${m+14}" fill="${u}" font-size="10">${this.formatValue(t.thermal/1e3,1)} kW</text>
              <text x="62" y="${m+28}" fill="${u}" font-size="9">COP ${this.formatValue(t.cop,2)}</text>
            </g>
