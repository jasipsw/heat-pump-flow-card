        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)">
              ...
              <g transform="translate(38, 5)" opacity="${this.config.heat_pump?.display_name?.9:0}">
                <!-- Curved C shape -->
