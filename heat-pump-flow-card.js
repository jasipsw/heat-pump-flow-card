        ...
        <div class="card-content">
          <svg viewBox="0 0 800 500" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="buffer-tank" transform="translate(350, 100)">
              ...
              <rect x="15" y="25" width="70" height="35" fill="${a}" opacity="0.9"/>

              <!-- Upper-middle section (warm) -->
              <rect x="15" y="60" width="70" height="40" fill="${a}" opacity="0.7"/>

              <!-- Lower-middle section (cooling) -->
              <rect x="15" y="100" width="70" height="40" fill="${l}" opacity="0.7"/>

              <!-- Bottom section (coldest - return temp) -->
              <rect x="15" y="140" width="70" height="35" fill="${l}" opacity="0.9"/>
