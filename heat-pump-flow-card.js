        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)" filter="url(#entity-shadow)">
              ...
              <text x="8" y="${E}" fill="${L}" font-size="10" font-weight="bold">IN</text>
              <text x="8" y="${E+12}" fill="${L}" font-size="10">${this.formatValue(t.power/1e3,1)} kW</text>

              <!-- Right column: OUTPUT parameters -->
              <text x="62" y="${E}" fill="${L}" font-size="10" font-weight="bold">OUT</text>
              <text x="62" y="${E+12}" fill="${L}" font-size="10">${this.formatValue(t.thermal/1e3,1)} kW</text>
              <text x="62" y="${E+24}" fill="${L}" font-size="9">COP ${this.formatValue(t.cop,2)}</text>
              <text x="62" y="${E+36}" fill="${L}" font-size="9">${this.formatValue(t.flowRate,1)} ${this.getStateUnit(this.config.heat_pump?.flow_rate_entity)||"L/m"}</text>
              ...
              ${void 0!==t.targetTemp?G`
                ${(()=>{const e=this.config.heat_pump?.hysteresis||5,i=t.targetTemp+e;return G`
                    ...
                    <text x="20" y="${97}" text-anchor="middle" fill="${L}" font-size="8" font-weight="bold">
                      ${this.formatValue(t.targetTemp,0)}°
                    </text>
              ...
              ${this.config.heat_pump?.show_detailed_metrics?G`
                <g id="hp-detailed-metrics" transform="translate(0, ${E+52})">
                  ...
                  ${void 0!==t.dischargeTemp?G`
                    <text x="42" y="8" fill="${L}" font-size="7" opacity="0.7">Disch</text>
                  ...
                  ${void 0!==t.ambientTemp?G`
                    <text x="76" y="8" fill="${L}" font-size="7" opacity="0.7">Amb</text>
                  ...
                  <!-- Row 2 -->
                  ${void 0!==t.dhwTemp?G`
                    <text x="8" y="26" fill="${L}" font-size="7" opacity="0.7">DHW</text>
                  ...
                  ${void 0!==t.outdoorCoilTemp?G`
                    <text x="42" y="26" fill="${L}" font-size="7" opacity="0.7">O-Coil</text>
                  ...
                  ${void 0!==t.suctionTemp?G`
                    <text x="76" y="26" fill="${L}" font-size="7" opacity="0.7">Suct</text>
                  ...
                  ${void 0!==t.heatExchangerTemp?G`
                    <text x="8" y="44" fill="${L}" font-size="7" opacity="0.7">HX</text>
                    <text x="8" y="51" fill="${L}" font-size="8" font-weight="bold">
            ...
            <g id="aux-heater"
              ...
              ${G`<rect x="${z}" y="${O}" width="${N}" height="${16}" rx="2" ry="2"
                    class="${pt}"
                    fill="${D}"
                    stroke="#7f8c8d"
