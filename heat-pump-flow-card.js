      ...
      <ha-card>
        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Temperature labels -->
            <text x="260" y="170" text-anchor="middle" fill="${a}" font-size="11" font-weight="bold">
            ...
            <text x="540" y="170" text-anchor="middle" fill="${h}" font-size="11" font-weight="bold">
            ...
            <g id="buffer-tank" transform="translate(350, 100)">
              ...
              <rect x="15" y="25" width="70" height="35" fill="${h}" opacity="0.9"/>

              <!-- Upper-middle section (warm) -->
              <rect x="15" y="60" width="70" height="40" fill="${h}" opacity="0.7"/>
