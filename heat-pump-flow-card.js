      ...
      <ha-card>
        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            ${this.renderIcon(this.config.dhw_tank?.tank_inlet_icon_url||"mdi:water-pump",250,395,50,50,.8)}
            ...
            ${a.enabled?G`
              ...
              ${this.renderIcon(this.config.dhw_tank_2?.tank_outlet_icon_url||"mdi:faucet-variant",710,355,50,50,.8)}
            `:G`
              <!-- Faucet icon at DHW tank 1 outlet (when tank 2 is disabled) -->
              ${this.renderIcon(this.config.dhw_tank?.tank_outlet_icon_url||"mdi:faucet-variant",550,355,50,50,.8)}
            `}
