        ...
        <div class="card-content">
          <svg viewBox="0 0 800 700" xmlns="http://www.w3.org/2000/svg">
            ...
            <g id="heat-pump" transform="translate(50, 100)">
              ...
              ${this.config.heat_pump?.logo_url?Q`
                <image x="5" y="1" width="16" height="16" href="${this.config.heat_pump.logo_url}" opacity="0.9"/>
              `:""}
              <text x="24" y="10" text-anchor="start" fill="${this.getHeatPumpColor(t)}" font-size="10" font-weight="bold">
